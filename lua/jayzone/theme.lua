...
function M.highlights()
    ...
    local highlights = {
        ...
        ["FzfLuaNormal"] = { fg = colors.white, bg = colors.none },
        ["FzfLuaBorder"] = { fg = colors.blue, bg = colors.none },
        ["FzfLuaTitle"] = { fg = colors.yellow },
        ["FzfLuaBackdrop"] = { bg = colors.none },
        ["FzfLuaPreviewNormal"] = { fg = colors.white },
        ["FzfLuaPreviewBorder"] = { fg = colors.blue, bg = colors.none },
        ["FzfLuaPreviewTitle"] = { fg = colors.yellow },
        -- ["FzfLuaCursor"] = { fg = colors.yellow, bg = colors.dark_grey },
        -- ["FzfLuaCursorLine"] = { fg = colors.change, bg = colors.change },
        -- ["FzfLuaCursorLineNr"] = { fg = colors.change, bg = colors.change },
        -- ["FzfLuaSearch"] = { fg = colors.change, bg = colors.change },
        -- ["FzfLuaScrollBorderEmpty"] = { fg = colors.change, bg = colors.change },
        -- ["FzfLuaScrollBorderFull"] = { fg = colors.change, bg = colors.change },
        -- ["FzfLuaScrollFloatEmpty"] = { fg = colors.change, bg = colors.change },
        -- ["FzfLuaScrollFloatFull"] = { fg = colors.change, bg = colors.change },
        -- ["FzfLuaHelpNormal"] = { fg = colors.change, bg = colors.change },
        -- ["FzfLuaHelpBorder"] = { fg = colors.change, bg = colors.change },
        -- ["FzfLuaHeaderBind"] = { fg = colors.change, bg = colors.change },
        ["FzfLuaHeaderText"] = { fg = colors.yellow },
        -- ["FzfLuaPathColNr"] = { fg = colors.change, bg = colors.change },
        -- ["FzfLuaPathLineNr"] = { fg = colors.change, bg = colors.change },
        -- ["FzfLuaBufName"] = { fg = colors.change, bg = colors.change },
        -- ["FzfLuaBufNr"] = { fg = colors.change, bg = colors.change },
        -- ["FzfLuaBufFlagCur"] = { fg = colors.change, bg = colors.change },
        -- ["FzfLuaBufFlagAlt"] = { fg = colors.change, bg = colors.change },
        ["FzfLuaTabTitle"] = { fg = colors.yellow },
        -- ["FzfLuaTabMarker"] = { fg = colors.change, bg = colors.change },
        -- ["FzfLuaDirIcon"] = { fg = colors.change, bg = colors.change },
        -- ["FzfLuaDirPart"] = { fg = colors.change, bg = colors.change },
        -- ["FzfLuaFilePart"] = { fg = colors.change, bg = colors.change },
        -- ["FzfLuaLiveSym"] = { fg = colors.change, bg = colors.change },
        -- ["FzfLuaFzfNormal"] = { fg = colors.change, bg = colors.change },
        ["FzfLuaFzfCursorLine"] = { bg = colors.dark_grey },
        ...
        -- ["FzfLuaFzfMarker"] = { fg = colors.change, bg = colors.change },
        -- ["FzfLuaFzfSpinner"] = { fg = colors.change, bg = colors.change },
        -- ["FzfLuaFzfPrompt"] = { fg = colors.change, bg = colors.change },
        -- ["FzfLuaFzfQuery"] = { fg = colors.change, bg = colors.change },
    ...
    local links = {
        ...
        ["@lsp.type.type_parameter.cs"] = "@typeParameter",
        ["@lsp.type.typeParameter.cs"] = "@typeParameter",
        ["@lsp.type.extension_method.cs"] = "@method",
        ["@lsp.type.extensionMethod.cs"] = "@method",
        ...
        ["@lsp.type.interfaceName.cs"] = "@interface",
        ["@lsp.type.struct_name.cs"] = "@struct",
        ["@lsp.type.structName.cs"] = "@struct",
        ["@lsp.type.field_name.cs"] = "@field",
        ["@lsp.type.fieldName.cs"] = "@field",
        ["@lsp.type.delegate_name.cs"] = "@method",
        ["@lsp.type.delegateName.cs"] = "@method",
