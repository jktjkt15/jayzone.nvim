...
function M.highlights()
	...
	local highlights = {
		...
		-- ["FzfLuaCursor"] = { fg = colors.change, bg = colors.change },
		...
		-- ["FzfLuaHeaderText"] = { fg = colors.change, bg = colors.change },
		...
		-- ["FzfLuaTabTitle"] = { fg = colors.change, bg = colors.change },
		...
		-- ["FzfLuaFzfCursorLine"] = { fg = colors.change, bg = colors.change },
		-- ["FzfLuaFzfMatch"] = { fg = colors.change, bg = colors.change },
		...
		-- ["FzfLuaFzfGutter"] = { fg = colors.change, bg = colors.change },
		-- ["FzfLuaFzfHeader"] = { fg = colors.change, bg = colors.change },
